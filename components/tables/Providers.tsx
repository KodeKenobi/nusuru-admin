...
export default function Providers({
  ...
  const handleDecline = async (providerId: string) => {
    const confirmed = window.confirm(
      "Are you sure you want to decline this provider?"
    );
    if (!confirmed) return;
    setLoadingId(providerId);
    await supabase
            ...
            <div className="p-6">
              <div className="flex items-center space-x-4 mb-6">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-[#666]">ID: {provider.id}</p>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <div
                      ...
                      onClick={() =>
                        ...
                        setSelectedImage({
                          url: provider.profile_picture_url,
                          alt: `${provider.first_name}'s profile`,
                        })
                      }
                    >
                      {provider.profile_picture_url ? (
              ...
              <div className="flex space-x-3">
                <button
                  onClick={() => handleEditUser(provider)}
